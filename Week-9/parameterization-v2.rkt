...
(check-expect (contains? "UBC" (cons "McGill" empty)) false)
(check-expect (contains? "UBC" (cons "UBC" empty)) true)
(check-expect (contains? "UBC" (cons "McGill" (cons "McGill" empty))) false)
(check-expect (contains? "UBC" (cons "McGill" (cons "UBC" empty))) true)
(check-expect (contains? "UBC" (cons "UBC" (cons "McGill" (cons "UBC" empty)))) true)
(check-expect (contains? "Toronto" (cons "UBC" (cons "McGill" (cons "UBC" empty)))) false)
...
;; produce list with only elements of lon where (pred n) produces true
...
(check-expect (filter2 odd? (list 1 2 3 4)) (list 1 3))
